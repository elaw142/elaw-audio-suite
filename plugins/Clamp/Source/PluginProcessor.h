...
class ClampAudioProcessor  : public juce::AudioProcessor
{
public:
    ClampAudioProcessor();
    ~ClampAudioProcessor() override;
...
private:
    ...
    juce::LinearSmoothedValue<float> punchSmoothed;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ClampAudioProcessor)
};
